...
public:
    ...
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_vecBaseVelocity;
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flStepSize;
    ...
    XoredNetvar< GET_XOR_KEYUI32, __COUNTER__ > m_flModelScale;
    ...
    void init( ) {
        ...
        INIT_XOREDNETVAR (m_flModelScale,               HASH("DT_BaseAnimating"),          HASH("m_flModelScale"));
