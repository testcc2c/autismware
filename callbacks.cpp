...
bool callbacks::IsBaimHealth() {
	return (g_menu.main.aimbot.baim2general.get(1) || g_menu.main.aimbot.baim2auto.get(1) || g_menu.main.aimbot.baim2scout.get(1) || g_menu.main.aimbot.baim2pistols.get(1) || g_menu.main.aimbot.baim2awp.get(1));
}
...
bool callbacks::IsWeaponNotGeneral() {
	return !g_menu.main.aimbot.weapon_select.get() == 0;
}
...
bool callbacks::IsDTHitchanceOnAuto() {
	return g_menu.main.aimbot.hitchance_dt_auto.get();
}
...
bool callbacks::IsDTHitchanceOnPistols() {
	return g_menu.main.aimbot.hitchance_dt_pistols.get();
}
...
bool callbacks::IsExploitLBYEnabled() {
	return g_menu.main.antiaim.body_fake_stand.get() == 2;
}

bool callbacks::IsTwistLBYEnabled() {
	return g_menu.main.antiaim.body_fake_stand.get() == 4;
}

bool callbacks::IsLBYBreakOn() {
	return !g_menu.main.antiaim.body_fake_stand.get() == 0;
}

bool callbacks::IsDistortOn() {
	return g_menu.main.antiaim.distortion.get();
}

bool callbacks::IsForceTurnOn() {
	return g_menu.main.antiaim.force_turn.get();
}

bool callbacks::IsZeusbotOn() {
	return g_menu.main.aimbot.zeusbot.get();
}

bool callbacks::IsShotchamsOn() {
...
bool callbacks::IsBuyBotOn() {
	return g_menu.main.misc.buybotenable.get();
}

bool callbacks::IsNameOn() {
	return !g_menu.main.players.name.GetActiveIndices().empty();
}

bool callbacks::IsWeaponESPOn() {
	return !g_menu.main.players.weapon.GetActiveIndices().empty();
}

bool callbacks::IsHealthESPOn() {
	return !g_menu.main.players.health.GetActiveIndices().empty();
}

bool callbacks::IsDroppedOn() {
	return g_menu.main.visuals.items.get();
}

bool callbacks::IsDroppedDistOn() {
	return g_menu.main.visuals.distance.get();
}

bool callbacks::IsDroppedAmmoOn() {
	return g_menu.main.visuals.ammo.get();
}

bool callbacks::IsShowSpreadOn() {
	return g_menu.main.visuals.spread_xhair.get();
}

bool callbacks::IsProjOn() {
	return g_menu.main.visuals.proj.get();
}

bool callbacks::IsMollyOn() {
	return g_menu.main.visuals.proj_range.get(0);
}

bool callbacks::IsSmokeOn() {
	return g_menu.main.visuals.proj_range.get(1);
}

bool callbacks::IsPenDotOn() {
	return g_menu.main.visuals.pen_crosshair.get() == 1;
}

bool callbacks::IsTracersOn() {
...
bool callbacks::IsModelscaleOn() {
	return g_menu.main.memes.modelscale.get();
}
...
bool callbacks::IsSkyBoxChange() {
	return g_menu.main.visuals.skyboxchange.get();
}
...
bool callbacks::IsOptifineBound() {
	return g_menu.main.memes.Optifine.get() != -1;
}
bool callbacks::IsFwBound() {
	return g_menu.main.movement.fakewalk.get() != -1;
}
bool callbacks::IsThirdPersonBound() {
	return g_menu.main.visuals.thirdperson.get() != -1;
}
bool callbacks::IsDTBound() {
