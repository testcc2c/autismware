...
void Client::DrawHUD() {
	...
	// colors
	const auto col_background = Color(40, 40, 50, 245);
	...
	if (ms == 0)
		text = tfm::format(XOR("AutismWare | Build: " __DATE__ " | Standing by"));
	else
		text = tfm::format(XOR("AutismWare | Build: " __DATE__ " | latency: %i ms"), ms);
...
void Client::ClanTag()
{
	...
	if (g_menu.main.misc.clantag.get()) {
		...
		{
			if (is_freeze_period && g_menu.main.memes.othertags.get() == 0)
			{
				SetClanTag(XOR("Autist\n"));
			}
			else if (is_freeze_period && g_menu.main.memes.othertags.get() == 1)
			{
				SetClanTag(XOR("| vulcan |"));
			}
			else if (is_freeze_period && g_menu.main.memes.othertags.get() == 2)
			{
				SetClanTag(XOR("*bigshart.xyz*"));
			}
			else if (is_freeze_period && g_menu.main.memes.othertags.get() == 3)
			{
				SetClanTag(XOR("*smallfart.xyz*"));
			}
			else if (is_freeze_period && g_menu.main.memes.othertags.get() == 4)
			{
				SetClanTag(XOR("no gpu\n"));
			}
		...
		if (iPrevFrame != int(g_csgo.m_globals->m_curtime * 3.7) % 26 && g_menu.main.memes.othertags.get() == 0) {
			switch (int(g_csgo.m_globals->m_curtime * 3.7) % 26) {
			case 0: {  SetClanTag(XOR(" ")); break; }
			case 1: {  SetClanTag(XOR("Au")); break; }
			case 2: {  SetClanTag(XOR("Aut")); break; }
			case 3: {  SetClanTag(XOR("Auti")); break; }
			case 4: {  SetClanTag(XOR("Autis")); break; }
			case 5: {  SetClanTag(XOR("Autism")); break; }
			case 6: {  SetClanTag(XOR("AutismW")); break; }
			case 7: {  SetClanTag(XOR("AutismWa")); break; }
			case 8: {  SetClanTag(XOR("AutismWar")); break; }
			case 9: {  SetClanTag(XOR("AutismWare")); break; }
			case 10: { SetClanTag(XOR("AutismWare\n")); break; }
			case 11: { SetClanTag(XOR("AutismWare\n")); break; }
			case 12: { SetClanTag(XOR("AutismWare\n")); break; }
			case 13: { SetClanTag(XOR("AutismWare")); break; }
			case 14: { SetClanTag(XOR("AutismWare")); break; }
			case 15: { SetClanTag(XOR("AutismWare")); break; }
			case 16: { SetClanTag(XOR("AutismWar")); break; }
			case 17: { SetClanTag(XOR("AutismWa")); break; }
			case 18: { SetClanTag(XOR("AutismW")); break; }
			case 19: { SetClanTag(XOR("Autism")); break; }
			case 20: { SetClanTag(XOR("Autis")); break; }
			case 21: { SetClanTag(XOR("Auti")); break; }
			case 22: { SetClanTag(XOR("Aut")); break; }
			case 23: { SetClanTag(XOR("Au")); break; }
			case 24: { SetClanTag(XOR("A")); break; }
			case 25: { SetClanTag(XOR(" ")); break; }
			default:;

			}
			iPrevFrame = int(g_csgo.m_globals->m_curtime * 3.7) % 26;
		}

		else if (iPrevFrame != int(g_csgo.m_globals->m_curtime * 3.6) % 18 && g_menu.main.memes.othertags.get() == 1) {
			switch (int(g_csgo.m_globals->m_curtime * 3.6) % 21) {
			case 0: {  SetClanTag(XOR("| |")); break; }
			case 1: {  SetClanTag(XOR("| v |")); break; }
			case 2: {  SetClanTag(XOR("| vu |")); break; }
			case 3: {  SetClanTag(XOR("| vul |")); break; }
			case 4: {  SetClanTag(XOR("| vulc |")); break; }
			case 5: {  SetClanTag(XOR("| vulca |")); break; }
			case 6: {  SetClanTag(XOR("| vulcan |")); break; }
			case 7: {  SetClanTag(XOR("| vulca |")); break; }
			case 8: {  SetClanTag(XOR("| vulc |")); break; }
			case 9: {  SetClanTag(XOR("| vul |")); break; }
			case 10: { SetClanTag(XOR("| vu |")); break; }
			case 11: { SetClanTag(XOR("| v |")); break; }
			case 12: { SetClanTag(XOR("| |")); break; }
			default:;
		...
		else if (iPrevFrame != int(g_csgo.m_globals->m_curtime * 2.9) % 14 && g_menu.main.memes.othertags.get() == 2) {
			switch (int(g_csgo.m_globals->m_curtime * 2.9) % 22) {
			case 0: {  SetClanTag(XOR("")); break; }
			case 1: {  SetClanTag(XOR("b")); break; }
			case 2: {  SetClanTag(XOR("bi")); break; }
			case 3: {  SetClanTag(XOR("big")); break; }
			case 4: {  SetClanTag(XOR("bigs")); break; }
			case 5: {  SetClanTag(XOR("bigsh")); break; }
			case 6: {  SetClanTag(XOR("bigsha")); break; }
			case 7: {  SetClanTag(XOR("bigshar")); break; }
			case 8: {  SetClanTag(XOR("bigshart")); break; }
			case 9: {  SetClanTag(XOR("bigshart.")); break; }
			case 10: { SetClanTag(XOR("bigshart.x")); break; }
			case 11: { SetClanTag(XOR("bigshart.xy")); break; }
			case 12: { SetClanTag(XOR("bigshart.xyz")); break; }
			case 13: { SetClanTag(XOR("bigshart.xy")); break; }
			case 14: { SetClanTag(XOR("bigshart.x")); break; }
			case 15: { SetClanTag(XOR("bigshart.")); break; }
			case 16: { SetClanTag(XOR("bigshart")); break; }
			case 17: { SetClanTag(XOR("bigshar")); break; }
			case 18: { SetClanTag(XOR("bigsha")); break; }
			case 19: { SetClanTag(XOR("bigsh")); break; }
			case 20: { SetClanTag(XOR("bigs")); break; }
			case 21: { SetClanTag(XOR("big")); break; }
			case 22: { SetClanTag(XOR("bi")); break; }
			case 23: { SetClanTag(XOR("b")); break; }
			default:;
		...
		else if (iPrevFrame != int(g_csgo.m_globals->m_curtime * 3.2) % 14 && g_menu.main.memes.othertags.get() == 3) {
			switch (int(g_csgo.m_globals->m_curtime * 3.2) % 24) {
			case 0: {  SetClanTag(XOR("")); break; }
			case 1: {  SetClanTag(XOR("s")); break; }
			case 2: {  SetClanTag(XOR("sm")); break; }
			case 3: {  SetClanTag(XOR("sma")); break; }
			case 4: {  SetClanTag(XOR("smal")); break; }
			case 5: {  SetClanTag(XOR("small")); break; }
			case 6: {  SetClanTag(XOR("smallf")); break; }
			case 7: {  SetClanTag(XOR("smallfa")); break; }
			case 8: {  SetClanTag(XOR("smallfar")); break; }
			case 9: {  SetClanTag(XOR("smallfart")); break; }
			case 10: { SetClanTag(XOR("smallfart.")); break; }
			case 11: { SetClanTag(XOR("smallfart.x")); break; }
			case 12: { SetClanTag(XOR("smallfart.xy")); break; }
			case 13: { SetClanTag(XOR("smallfart.xyz")); break; }
			case 14: { SetClanTag(XOR("smallfart.xy")); break; }
			case 15: { SetClanTag(XOR("smallfart.x")); break; }
			case 16: { SetClanTag(XOR("smallfart.")); break; }
			case 17: { SetClanTag(XOR("smallfart")); break; }
			case 18: { SetClanTag(XOR("smallfar")); break; }
			case 19: { SetClanTag(XOR("smallfa")); break; }
			case 20: { SetClanTag(XOR("smallf")); break; }
			case 21: { SetClanTag(XOR("small")); break; }
			case 22: { SetClanTag(XOR("smal")); break; }
			case 23: { SetClanTag(XOR("sma")); break; }
			case 24: { SetClanTag(XOR("sm")); break; }
			case 25: { SetClanTag(XOR("s")); break; }
			default:;

			}
			iPrevFrame = int(g_csgo.m_globals->m_curtime * 3.2) % 14;
		}

		else if (iPrevFrame != int(g_csgo.m_globals->m_curtime * 3.7) % 29 && g_menu.main.memes.othertags.get() == 4) {
			switch (int(g_csgo.m_globals->m_curtime * 3.7) % 29) {
			case 0: {  SetClanTag(XOR(" ")); break; }
			case 1: {  SetClanTag(XOR("N")); break; }
			case 2: {  SetClanTag(XOR("N0")); break; }
			case 3: {  SetClanTag(XOR("No")); break; }
			case 4: {  SetClanTag(XOR("No6")); break; }
			case 5: {  SetClanTag(XOR("NoG")); break; }
			case 6: {  SetClanTag(XOR("NoGp")); break; }
			case 7: {  SetClanTag(XOR("NoGpu")); break; }
			case 8: {  SetClanTag(XOR("NoGpuH")); break; }
			case 9: {  SetClanTag(XOR("NoGpuH4")); break; }
			case 10: { SetClanTag(XOR("NoGpuHa")); break; }
			case 11: { SetClanTag(XOR("NoGpuHac")); break; }
			case 12: { SetClanTag(XOR("NoGpuHac|")); break; }
			case 13: { SetClanTag(XOR("NoGpuHac|<")); break; }
			case 14: { SetClanTag(XOR("NoGpuHack")); break; }
			case 15: { SetClanTag(XOR("NoGpuHack")); break; }
			case 16: { SetClanTag(XOR("NoGpuHack")); break; }
			case 17: { SetClanTag(XOR("NoGpuHac|<")); break; }
			case 18: { SetClanTag(XOR("NoGpuHac|")); break; }
			case 19: { SetClanTag(XOR("NoGpuHac")); break; }
			case 20: { SetClanTag(XOR("NoGpuHa")); break; }
			case 21: { SetClanTag(XOR("NoGpuH")); break; }
			case 22: { SetClanTag(XOR("NoGpu")); break; }
			case 23: { SetClanTag(XOR("NoGp")); break; }
			case 24: { SetClanTag(XOR("NoG")); break; }
			case 25: { SetClanTag(XOR("No")); break; }
			case 26: { SetClanTag(XOR("N0")); break; }
			case 27: { SetClanTag(XOR("N ")); break; }
			case 28: { SetClanTag(XOR(" ")); break; }
			default:;

			}
			iPrevFrame = int(g_csgo.m_globals->m_curtime * 2.7) % 29;
		}
...
void Client::Skybox()
{
	...
	if (g_menu.main.visuals.skyboxchange.get()) {
...
void Client::OnPaint() {
	...
	// AspectRatio code cus im lazy and didnt wanna make a new void in visuals.cpp.
	auto value = g_menu.main.misc.Aspect.get();
...
void Client::StartMove(CUserCmd* cmd) {
	...
	bool bOnGround = m_local->m_fFlags() & FL_ONGROUND;
	bool bJumped = false;
	bool bLandedOnServer = false;
	float flLandTime = 0.f;

	if (FL_ONGROUND) {
		flLandTime = m_anim_time - float(m_layers[4].m_playback_rate / m_layers[4].m_cycle);
...
void Client::DoMove() {
	...
	constexpr static int	switch_rate = 6;
	...
	if (g_menu.main.misc.legbreaker.get()) {
		(side_switch ? g_menu.main.misc.slide_walk.set(false) : g_menu.main.misc.slide_walk.set(true));
	}
	...
	// backup offsets.
	static float offsetz = g_csgo.m_cvar->FindVar(HASH("viewmodel_offset_z"))->GetFloat();
	static float offsety = g_csgo.m_cvar->FindVar(HASH("viewmodel_offset_y"))->GetFloat();
	static float offsetx = g_csgo.m_cvar->FindVar(HASH("viewmodel_offset_x"))->GetFloat();
	
	// wiggly arms.
	if (g_menu.main.memes.wigglyarms.get()) {
		g_csgo.m_cvar->FindVar(HASH("viewmodel_offset_z"))->SetValue(math::random_float(-2, 2));
		g_csgo.m_cvar->FindVar(HASH("viewmodel_offset_y"))->SetValue(math::random_float(-2, 2));
		g_csgo.m_cvar->FindVar(HASH("viewmodel_offset_x"))->SetValue(math::random_float(-2.5, 2.5));
	}
	else {
		g_csgo.m_cvar->FindVar(HASH("viewmodel_offset_z"))->SetValue(offsetz);
		g_csgo.m_cvar->FindVar(HASH("viewmodel_offset_y"))->SetValue(offsety);
		g_csgo.m_cvar->FindVar(HASH("viewmodel_offset_x"))->SetValue(offsetx);
	}

	// funny model.
	float scale = g_menu.main.memes.modelscale_amt.get();
	if (g_menu.main.memes.modelscale.get())
		m_local->m_flModelScale() = scale;
	else
		m_local->m_flModelScale() = 1.f;
...
void Client::UpdateAnimations() {
	...
	// fix model folding
	if (state->m_land && !(g_cl.m_cmd->m_buttons & IN_JUMP)) {
		if (g_cl.m_local->m_bDucking()) {
			...
			// update animations with last networked simulation time so we don't look as fake laggy
			if (g_cl.m_sim_time != g_cl.m_local->m_flSimulationTime())
				g_cl.m_local->m_flSimulationTime() = g_cl.m_sim_time;

			// fix feet from going all fucking retarded
			if (state->m_cur_feet_yaw > 0.f) {
...
void Client::UpdateInformation() {
	...
	g_cl.m_sim_time = g_cl.m_local->m_flSimulationTime();
...
void Client::print(const std::string text, ...) {
	...
	// print to console.
	g_csgo.m_cvar->ConsoleColorPrintf(g_menu.main.misc.menu_color.get(), XOR("[AutismWare] "));
