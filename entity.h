...
public:
	...
	util::datamap_t* GetDataDescMap()
	{
		typedef util::datamap_t* (__thiscall* o_GetPredDescMap)(void*);
		return util::get_method< o_GetPredDescMap >(this, 15)(this);
	}

	util::datamap_t* GetPredDescMap()
	{
		typedef util::datamap_t* (__thiscall* o_GetPredDescMap)(void*);
...
public:
	...
	{
		static unsigned int _m_vecBaseVelocity = util::FindInDataMap(GetPredDescMap(), "m_vecBaseVelocity");
...
public:
	...
	int GetHealth()
	{
		return *reinterpret_cast<int*>(uintptr_t(this) + g_entoffsets.m_iHealth);
	}
...
public:
	...
	__forceinline bool DTable() {
		int WeaponId = this->m_iItemDefinitionIndex();
		return IsGun() && WeaponId != AWP && WeaponId != REVOLVER && WeaponId != ZEUS;
	}
