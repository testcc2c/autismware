...
public:
	...
	Slider        override_dmg_value_pistols;
	Slider        override_dmg_value_scout;
	Slider        override_dmg_value_auto;
	Slider        override_dmg_value_awp;
	Checkbox      override;
	...
	Checkbox      hitchance_dt_auto;
	Slider        hitchance_dt_amount_auto;
	...
	Checkbox      hitchance_dt_pistols;
	Slider        hitchance_dt_amount_pistols;
	...
	MultiDropdown baim1general;
	MultiDropdown baim1auto;
	MultiDropdown baim1scout;
	MultiDropdown baim1pistols;
	MultiDropdown baim1awp;

	MultiDropdown baim2general;
	MultiDropdown baim2auto;
	MultiDropdown baim2scout;
	MultiDropdown baim2pistols;
	MultiDropdown baim2awp;

	MultiDropdown head1general;
	MultiDropdown head1auto;
	MultiDropdown head1scout;
	MultiDropdown head1pistols;
	MultiDropdown head1awp;
...
public:
	void init() {
		...
		hitbox_history_general.setup(XOR("Backtrack hitboxes"), XOR("hitbox_history_general"), { XOR("Head"), XOR("Chest"), XOR("Body"), XOR("Arms"), XOR("Legs"), XOR("Feet") });
		...
		body_scale_general.setup(XOR("Body scale"), XOR("body_hitbox_scale_general"), 1.f, 100.f, true, 0, 50.f, 1.f, XOR(L"%"));
		...
		hitchance_dt_auto.setup(XOR("Doubletap hitchance"), XOR("hitchance_dt_auto"));
		hitchance_dt_auto.AddShowCallback(callbacks::IsWeaponAuto);
		RegisterElement(&hitchance_dt_auto);

		hitchance_dt_amount_auto.setup("", XOR("dtauto"), 1.f, 50.f, false, 0, 35.f, 1.f, XOR(L"%"));
		hitchance_dt_amount_auto.AddShowCallback(callbacks::IsWeaponAuto);
		hitchance_dt_amount_auto.AddShowCallback(callbacks::IsDTHitchanceOnAuto);
		RegisterElement(&hitchance_dt_amount_auto);
		...
		hitchance_dt_pistols.setup(XOR("Doubletap hitchance"), XOR("hitchance_dt_pistols"));
		hitchance_dt_pistols.AddShowCallback(callbacks::IsWeaponPistol);
		RegisterElement(&hitchance_dt_pistols);

		hitchance_dt_amount_pistols.setup("", XOR("dtpistols"), 1.f, 50.f, false, 0, 35.f, 1.f, XOR(L"%"));
		hitchance_dt_amount_pistols.AddShowCallback(callbacks::IsWeaponPistol);
		hitchance_dt_amount_pistols.AddShowCallback(callbacks::IsDTHitchanceOnPistols);
		RegisterElement(&hitchance_dt_amount_pistols);
		...
		minimal_damage_hp_general.setup(XOR("Dynamic"), XOR("minimal_damage_hp_general"));
		...
		penetrate_minimal_damage_hp_general.setup(XOR("Dynamic"), XOR("penetrate_minimal_damage_hp_general"));
		...
		hitbox_history_auto.setup(XOR("Backtrack hitboxes"), XOR("hitbox_history_auto"), { XOR("Head"), XOR("Chest"), XOR("Body"), XOR("Arms"), XOR("Legs"), XOR("Feet") });
		...
		body_scale_auto.setup(XOR("Body scale"), XOR("body_hitbox_scale_auto"), 1.f, 100.f, true, 0, 50.f, 1.f, XOR(L"%"));
		...
		minimal_damage_hp_auto.setup(XOR("Dynamic"), XOR("minimal_damage_hp_auto"));
		...
		penetrate_minimal_damage_hp_auto.setup(XOR("Dynamic"), XOR("penetrate_minimal_damage_hp_auto"));
		...
		hitbox_history_awp.setup(XOR("Backtrack hitboxes"), XOR("hitbox_history_awp"), { XOR("Head"), XOR("Chest"), XOR("Body"), XOR("Arms"), XOR("Legs"), XOR("Feet") });
		...
		body_scale_awp.setup(XOR("Body scale"), XOR("body_hitbox_scale_awp"), 1.f, 100.f, true, 0, 50.f, 1.f, XOR(L"%"));
		...
		minimal_damage_awp.setup(XOR("Minimum damage"), XOR("minimal_damage_awp"), 1.f, 110.f, true, 0, 40.f, 1.f);
		minimal_damage_awp.AddShowCallback(callbacks::IsWeaponAWP);
		RegisterElement(&minimal_damage_awp);

		minimal_damage_hp_awp.setup(XOR("Dynamic"), XOR("minimal_damage_hp_awp"));
		...
		penetrate_minimal_damage_awp.setup("", XOR("penetrate_minimal_damage_awp"), 1.f, 110.f, false, 0, 30.f, 1.f);
		...
		penetrate_minimal_damage_hp_awp.setup(XOR("Dynamic"), XOR("penetrate_minimal_damage_hp_awp"));
		...
		hitbox_history_scout.setup(XOR("Backtrack hitboxes"), XOR("hitbox_history_scout"), { XOR("Head"), XOR("Chest"), XOR("Body"), XOR("Arms"), XOR("Legs"), XOR("Feet") });
		...
		body_scale_scout.setup(XOR("Body scale"), XOR("body_hitbox_scale_scout"), 1.f, 100.f, true, 0, 50.f, 1.f, XOR(L"%"));
		...
		minimal_damage_scout.setup(XOR("Minimum damage"), XOR("minimal_damage_scout"), 1.f, 110.f, true, 0, 40.f, 1.f);
		minimal_damage_scout.AddShowCallback(callbacks::IsWeaponScout);
		RegisterElement(&minimal_damage_scout);

		minimal_damage_hp_scout.setup(XOR("Dynamic"), XOR("minimal_damage_hp_scout"));
		...
		penetrate_minimal_damage_scout.setup("", XOR("penetrate_minimal_damage_scout"), 1.f, 110.f, false, 0, 30.f, 1.f);
		...
		penetrate_minimal_damage_hp_scout.setup(XOR("Dynamic"), XOR("penetrate_minimal_damage_hp_scout"));
		...
		hitbox_history_pistols.setup(XOR("Backtrack hitboxes"), XOR("hitbox_history_pistols"), { XOR("Head"), XOR("Chest"), XOR("Body"), XOR("Arms"), XOR("Legs"), XOR("Feet") });
		...
		body_scale_pistols.setup(XOR("Body scale"), XOR("body_hitbox_scale_pistols"), 1.f, 100.f, true, 0, 50.f, 1.f, XOR(L"%"));
		...
		minimal_damage_hp_pistols.setup(XOR("Dynamic"), XOR("minimal_damage_hp_pistols"));
		...
		penetrate_minimal_damage_hp_pistols.setup(XOR("Dynamic"), XOR("penetrate_minimal_damage_hp_pistols"));
		...
		//plusonescout.setup(XOR("HP +1 Min dmg"), XOR("plusonescout"));
		//plusonescout.AddShowCallback(callbacks::IsWeaponScout);
		//RegisterElement(&plusonescout);

		//plusoneawp.setup(XOR("HP +1 Min dmg"), XOR("plusoneawp"));
		//plusoneawp.AddShowCallback(callbacks::IsWeaponAWP);
		//RegisterElement(&plusoneawp);
		...
		hitchance_amount_zeus.setup("", XOR("hitchance_amount_zeus"), 1.f, 100.f, false, 0, 80.f, 1.f, XOR(L"%"));
		hitchance_amount_zeus.AddShowCallback(callbacks::IsZeusbotOn);
		RegisterElement(&hitchance_amount_zeus);
		...
		resolver.setup(XOR("Resolver"), XOR("correct"));
		RegisterElement(&resolver, 1);

		// prefer cases

		baim1general.setup(XOR("Prefer body aim"), XOR("baim1general"), { XOR("Always"), XOR("Lethal"), XOR("Lethal x2"), XOR("Stand"), XOR("In air") });
		baim1general.AddShowCallback(callbacks::IsWeaponGeneral);
		RegisterElement(&baim1general, 1);

		baim1auto.setup(XOR("Prefer body aim"), XOR("baim1auto"), { XOR("Always"), XOR("Lethal"), XOR("Lethal x2"), XOR("Stand"), XOR("In air") });
		baim1auto.AddShowCallback(callbacks::IsWeaponAuto);
		RegisterElement(&baim1auto, 1);

		baim1scout.setup(XOR("Prefer body aim"), XOR("baim1scout"), { XOR("Always"), XOR("Lethal"), XOR("Lethal x2"), XOR("Stand"), XOR("In air") });
		baim1scout.AddShowCallback(callbacks::IsWeaponScout);
		RegisterElement(&baim1scout, 1);

		baim1pistols.setup(XOR("Prefer body aim"), XOR("baim1pistols"), { XOR("Always"), XOR("Lethal"), XOR("Lethal x2"), XOR("Stand"), XOR("In air") });
		baim1pistols.AddShowCallback(callbacks::IsWeaponPistol);
		RegisterElement(&baim1pistols, 1);

		baim1awp.setup(XOR("Prefer body aim"), XOR("baim1awp"), { XOR("Always"), XOR("Lethal"), XOR("Lethal x2"), XOR("Stand"), XOR("In air") });
		baim1awp.AddShowCallback(callbacks::IsWeaponAWP);
		RegisterElement(&baim1awp, 1);

		baim2general.setup(XOR("Force body aim"), XOR("baim2general"), { XOR("Always"), XOR("Health"), XOR("Stand"), XOR("In air") });
		baim2general.AddShowCallback(callbacks::IsWeaponGeneral);
		RegisterElement(&baim2general, 1);

		baim2auto.setup(XOR("Force body aim"), XOR("baim2auto"), { XOR("Always"), XOR("Health"), XOR("Stand"), XOR("In air") });
		baim2auto.AddShowCallback(callbacks::IsWeaponAuto);
		RegisterElement(&baim2auto, 1);

		baim2scout.setup(XOR("Force body aim"), XOR("baim2scout"), { XOR("Always"), XOR("Health"), XOR("Stand"), XOR("In air") });
		baim2scout.AddShowCallback(callbacks::IsWeaponScout);
		RegisterElement(&baim2scout, 1);

		baim2pistols.setup(XOR("Force body aim"), XOR("baim2pistols"), { XOR("Always"), XOR("Health"), XOR("Stand"), XOR("In air") });
		baim2pistols.AddShowCallback(callbacks::IsWeaponPistol);
		RegisterElement(&baim2pistols, 1);

		baim2awp.setup(XOR("Force body aim"), XOR("baim2awp"), { XOR("Always"), XOR("Health"), XOR("Stand"), XOR("In air") });
		baim2awp.AddShowCallback(callbacks::IsWeaponAWP);
		RegisterElement(&baim2awp, 1);
		
		head1general.setup(XOR("Prefer head aim"), XOR("head1general"), { XOR("Always"), XOR("Moving"), XOR("Last move"), XOR("In air")});
		head1general.AddShowCallback(callbacks::IsWeaponGeneral);
		RegisterElement(&head1general, 1);

		head1auto.setup(XOR("Prefer head aim"), XOR("head1auto"), { XOR("Always"), XOR("Moving"), XOR("Last move"), XOR("In air") });
		head1auto.AddShowCallback(callbacks::IsWeaponAuto);
		RegisterElement(&head1auto, 1);

		head1scout.setup(XOR("Prefer head aim"), XOR("head1scout"), { XOR("Always"), XOR("Moving"), XOR("Last move"), XOR("In air") });
		head1scout.AddShowCallback(callbacks::IsWeaponScout);
		RegisterElement(&head1scout, 1);

		head1pistols.setup(XOR("Prefer head aim"), XOR("head1pistols"), { XOR("Always"), XOR("Moving"), XOR("Last move"), XOR("In air") });
		head1pistols.AddShowCallback(callbacks::IsWeaponPistol);
		RegisterElement(&head1pistols, 1);

		head1awp.setup(XOR("Prefer head aim"), XOR("head1awp"), { XOR("Always"), XOR("Moving"), XOR("Last move"), XOR("In air") });
		head1awp.AddShowCallback(callbacks::IsWeaponAWP);
		RegisterElement(&head1awp, 1);
		...
		override_dmg_key.AddShowCallback(callbacks::IsWeaponNotGeneral);
		override_dmg_key.SetToggleCallback(callbacks::ToggleDMG);
		RegisterElement(&override_dmg_key, 1);

		override_dmg_value_pistols.setup(" ", XOR("dmg_override_pistols"), 1.f, 110.f, false, 0, 1.f, 1.f, XOR(L"hp"));
		override_dmg_value_pistols.AddShowCallback(callbacks::IsWeaponPistol);
		override_dmg_value_pistols.AddShowCallback(callbacks::IsOverrideDamage);
		RegisterElement(&override_dmg_value_pistols, 1);

		override_dmg_value_scout.setup(" ", XOR("dmg_override_scout"), 1.f, 110.f, false, 0, 1.f, 1.f, XOR(L"hp"));
		override_dmg_value_scout.AddShowCallback(callbacks::IsWeaponScout);
		override_dmg_value_scout.AddShowCallback(callbacks::IsOverrideDamage);
		RegisterElement(&override_dmg_value_scout, 1);

		override_dmg_value_auto.setup(" ", XOR("dmg_override_auto"), 1.f, 110.f, false, 0, 1.f, 1.f, XOR(L"hp"));
		override_dmg_value_auto.AddShowCallback(callbacks::IsWeaponAuto);
		override_dmg_value_auto.AddShowCallback(callbacks::IsOverrideDamage);
		RegisterElement(&override_dmg_value_auto, 1);

		override_dmg_value_awp.setup(" ", XOR("dmg_override_awp"), 1.f, 110.f, false, 0, 1.f, 1.f, XOR(L"hp"));
		override_dmg_value_awp.AddShowCallback(callbacks::IsWeaponAWP);
		override_dmg_value_awp.AddShowCallback(callbacks::IsOverrideDamage);
		RegisterElement(&override_dmg_value_awp, 1);
		...
		debugaimcol.AddShowCallback(callbacks::IsShotchamsOn);
...
public:
	...
	Checkbox targetbreak;
	Checkbox disablelbyfw;
	Dropdown sideselect;
	Dropdown sideselecttwist;
...
public:
	void init() {
		...
		force_turn.AddShowCallback(callbacks::IsDistortOn);
		RegisterElement(&force_turn);

		distortdelta.setup(XOR("Distortion delta"), XOR("distortdelta"), 35.f, 200.f, true, 0, 45.f, 5.f, XOR(L"°"));
		distortdelta.AddShowCallback(callbacks::IsDistortOn);
		distortdelta.AddShowCallback(callbacks::IsForceTurnOff);
		RegisterElement(&distortdelta);

		distortspeed.setup(XOR("Distortion speed"), XOR("distortspeed"), 1.f, 10.f, true, 0, 5.f, 1.f, XOR(L"%"));
		distortspeed.AddShowCallback(callbacks::IsDistortOn);
		RegisterElement(&distortspeed);

		edge.setup(XOR("Freestand"), XOR("edge"), { XOR("Off"), XOR("Normal"), XOR("Reversed") });
		RegisterElement(&edge);

		mode.setup(XOR("Mode"), XOR("Mode"), { XOR("Stand"), XOR("Walk"), XOR("Air") }, false);
		RegisterElement(&mode);

		// stand.
		pitch_stand.setup(XOR("Pitch"), XOR("pitch_stnd"), { XOR("Off"), XOR("Down"), XOR("Up"), XOR("Fake up"), XOR("Fake down") });
		...
		dir_custom_stand.setup("", XOR("dir_custom_stnd"), -180.f, 180.f, false, 0, 0.f, 1.f, XOR(L"°"));
		...
		body_fake_stand.setup(XOR("Lby breaker"), XOR("body_fake_stnd"), { XOR("Off"), XOR("Break logic"), XOR("Exploit"), XOR("Random"), XOR("Twist"), XOR("Clock"), XOR("Custom")});
		...
		sideselect.setup(XOR("Flick side"), XOR("sideselect"), { XOR("Left"), XOR("Right") });
		sideselect.AddShowCallback(callbacks::IsAntiAimModeStand);
		sideselect.AddShowCallback(callbacks::HasStandYaw);
		sideselect.AddShowCallback(callbacks::IsExploitLBYEnabled);
		RegisterElement(&sideselect);
		...
		targetbreak.setup(XOR("Target break"), XOR("targetbreak"));
		targetbreak.AddShowCallback(callbacks::IsLBYBreakOn);
		targetbreak.AddShowCallback(callbacks::IsAntiAimModeStand);
		RegisterElement(&targetbreak);

		/*uppitchonlby.setup(XOR("Up pitch on lby"), XOR("upolu"));
		uppitchonlby.AddShowCallback(callbacks::IsLBYBreakOn);
		uppitchonlby.AddShowCallback(callbacks::IsAntiAimModeStand);
		RegisterElement(&uppitchonlby);
		*/
		...
		// walk.
		pitch_walk.setup(XOR("Pitch"), XOR("pitch_walk"), { XOR("Off"), XOR("Down"), XOR("Up"), XOR("Fake up"), XOR("Fake down") });
		...
		// air.
		pitch_air.setup(XOR("Pitch"), XOR("pitch_air"), { XOR("Off"), XOR("Down"), XOR("Up"), XOR("Fake up"), XOR("Fake down") });
		...
		// col2.
		fake_yaw.setup(XOR("Fake yaw"), XOR("fake_yaw"), { XOR("off"), XOR("Default"), XOR("Relative"), XOR("Jitter"), XOR("Rotate"), XOR("Random"), XOR("Spin"), XOR("Breaker"), XOR("Break"), XOR("Low delta")});
		...
		lag_active.setup("", XOR("lag_active"), { XOR("Stand"), XOR("Move"), XOR("Air"), XOR("Crouch"), XOR("Lby flick"), XOR("Reloading"), XOR("Weapon switch"), XOR("Always")}, false);
		lag_active.AddShowCallback(callbacks::IsFakeLagOn);
		RegisterElement(&lag_active, 1);

		lag_mode.setup("", XOR("lag_mode"), { XOR("Max"), XOR("Break"), XOR("Random"), XOR("Break step"), XOR("Dynamic") }, false);
		lag_mode.AddShowCallback(callbacks::IsFakeLagOn);
		RegisterElement(&lag_mode, 1);

		lag_limit.setup(XOR("Limit"), XOR("lag_limit"), 2, 16, true, 0, 2, 1.f, XOR(L"t"));
		...
		disablefakelagonkey.AddShowCallback(callbacks::IsFakeLagOn);
		RegisterElement(&disablefakelagonkey, 1);

		lag_land.setup(XOR("On land"), XOR("lag_land"));
		lag_land.AddShowCallback(callbacks::IsFakeLagOn);
		RegisterElement(&lag_land, 1);

		revoler_disable.setup(XOR("Disable fake-lag with revolver"), XOR("revolver_disable"));
		revoler_disable.AddShowCallback(callbacks::IsFakeLagOn);
		RegisterElement(&revoler_disable, 1);

		disablelbyfw.setup(XOR("Disable lby on fake-walk"), XOR("disablelbyfw"));
		disablelbyfw.AddShowCallback(callbacks::IsFakeLagOn);
		RegisterElement(&disablelbyfw, 1);
		...
		color_manul_antiaim.AddShowCallback(callbacks::IsManAAOn);
		...
		color_draw_angles_chams.AddShowCallback(callbacks::IsFakeChamsOn);
		...
		draw_angles_chams_blend.AddShowCallback(callbacks::IsFakeChamsOn);
...
public:
	void init() {
		...
		offscreen_mode.setup(XOR("Offscreen arrow size"), XOR("offscreen_mode"), 20.f, 200.f, true, 0, 100.f, 1.f, XOR(L""));
		offscreen_mode.AddShowCallback(callbacks::IsOffScreenOn);
		RegisterElement(&offscreen_mode);

		offscreen_mode1.setup(XOR("Offscreen arrow distance"), XOR("offscreen_mode1"), 20.f, 200.f, true, 0, 200.f, 1.f, XOR(L""));
		offscreen_mode1.AddShowCallback(callbacks::IsOffScreenOn);
		...
		healthbartype.setup(XOR(""), XOR("healthbartype"), { XOR("Side"), XOR("Top") }, false);
		healthbartype.AddShowCallback(callbacks::IsHealthESPOn);
		RegisterElement(&healthbartype);

		flags_enemy.setup(XOR("Flags enemy"), XOR("flags_enemy"), { XOR("Money"), XOR("Armor"), XOR("Scoped"), XOR("Flashed"), XOR("Reloading"), XOR("Bomb"), XOR("Resolver mode") });
		...
		weapon_mode.AddShowCallback(callbacks::IsWeaponESPOn);
		...
		chams_enemy_mat.setup(XOR("Enemy chams material"), XOR("chams_enemy_mat"), { XOR("Default"), XOR("Flat"), XOR("Metallic"), XOR("Outline"), XOR("Ghost"), XOR("Skeet"), XOR("Onetap")});
		...
		chams_enemy_history_mat.setup(XOR("Backtrack chams material"), XOR("chams_enemy_history_mat"), { XOR("Default"), XOR("Flat"), XOR("Metallic"), XOR("Outline"), XOR("Ghost"), XOR("Skeet"), XOR("Onetap") });
		chams_enemy_history_mat.AddShowCallback(callbacks::IsEnemyChams);
		chams_enemy_history_mat.AddShowCallback(callbacks::IsBtChamsOn);
		...
		chams_enemy_history_col.AddShowCallback(callbacks::IsBtChamsOn);
		...
		chams_enemy_history_blend.AddShowCallback(callbacks::IsBtChamsOn);
		...
		chams_friendly_mat.setup(XOR("Teammate chams material"), XOR("chams_friendly_mat"), { XOR("Default"), XOR("Flat"), XOR("Metallic"), XOR("Outline"), XOR("Ghost"), XOR("Skeet"), XOR("Onetap"), XOR("Animated wireframe") });
		...
		chams_local_mat.setup(XOR("Local chams material"), XOR("chams_local_mat"), { XOR("Default"), XOR("Flat"), XOR("Metallic"), XOR("Outline"), XOR("Ghost"), XOR("Skeet"), XOR("Onetap"), XOR("Animated wireframe") });
...
public:
	void init() {
		...
		distance.AddShowCallback(callbacks::IsDroppedOn);
		RegisterElement(&distance);

		item_color.setup(XOR("Color"), XOR("item_color"), colors::white);
		item_color.AddShowCallback(callbacks::IsDroppedDistOn);
		item_color.AddShowCallback(callbacks::IsDroppedOn);
		RegisterElement(&item_color);

		ammo.setup(XOR("Dropped weapons ammo"), XOR("ammo"));
		ammo.AddShowCallback(callbacks::IsDroppedOn);
		RegisterElement(&ammo);

		dropammo_color.setup(XOR("Color"), XOR("dropammo_color"), colors::light_blue);
		dropammo_color.AddShowCallback(callbacks::IsDroppedAmmoOn);
		dropammo_color.AddShowCallback(callbacks::IsDroppedOn);
		...
		proj_color.AddShowCallback(callbacks::IsProjOn);
		RegisterElement(&proj_color);

		proj_range.setup(XOR("Projectile circle"), XOR("proj_range"), { XOR("Molly"), XOR("Smoke") });
		proj_range.AddShowCallback(callbacks::IsProjOn);
		RegisterElement(&proj_range);

		proj_range_color.setup(XOR("Molly color"), XOR("proj_range_color"), colors::white);
		proj_range_color.AddShowCallback(callbacks::IsProjOn);
		proj_range_color.AddShowCallback(callbacks::IsMollyOn);
		RegisterElement(&proj_range_color);

		proj_range_color2.setup(XOR("Smoke color"), XOR("proj_range_color2"), colors::white);
		proj_range_color2.AddShowCallback(callbacks::IsProjOn);
		proj_range_color2.AddShowCallback(callbacks::IsSmokeOn);
		RegisterElement(&proj_range_color2);
		...
		fov_amt.AddShowCallback(callbacks::IsOvrFovOn);
		RegisterElement(&fov_amt, 1);

		fov_scoped.setup(XOR("Override fov when scoped"), XOR("fov_scoped"));
		fov_scoped.AddShowCallback(callbacks::IsOvrFovOn);
		...
		viewmodel_fov_amt.AddShowCallback(callbacks::IsOvrViewOn);
		...
		spread_xhair_col.AddShowCallback(callbacks::IsShowSpreadOn);
		RegisterElement(&spread_xhair_col, 1);

		spread_xhair_blend.setup("", XOR("spread_xhair_blend"), 10.f, 100.f, false, 0, 100.f, 1.f, XOR(L"%"));
		spread_xhair_blend.AddShowCallback(callbacks::IsShowSpreadOn);
		RegisterElement(&spread_xhair_blend, 1);

		pen_crosshair.setup(XOR("Penetration crosshair"), XOR("pen_xhair"), { XOR("Off"), XOR("Dot"), XOR("Square")});
		RegisterElement(&pen_crosshair, 1);

		pen_damage.setup(XOR("Penetration damage"), XOR("pen_damage"));
		pen_damage.AddShowCallback(callbacks::IsPenDotOn);
		RegisterElement(&pen_damage, 1);

		indicators.setup(XOR("Indicators"), XOR("indicators"), { XOR("Lby"), XOR("Lag compensation"), XOR("Ping"), XOR("Doubletap"), XOR("Min dmg override"), XOR("Auto peek") });
		...
		impact_beams_color.AddShowCallback(callbacks::IsTracersOn);
		RegisterElement(&impact_beams_color, 1);

		impact_beams_hurt_color.setup(XOR("Hit color"), XOR("impact_beams_hurt_color"), colors::red);
		impact_beams_hurt_color.AddShowCallback(callbacks::IsTracersOn);
		RegisterElement(&impact_beams_hurt_color, 1);

		impact_beams_time.setup(XOR("Bullet tracers time"), XOR("impact_beams_time"), 1.f, 10.f, true, 0, 1.f, 1.f, XOR(L""));
		impact_beams_time.AddShowCallback(callbacks::IsTracersOn);
		...
		thirdperson_distance.AddShowCallback(callbacks::IsThirdPersonBound);
...
public:
	void init() {
		...
		autostop_always_on.setup(XOR("Autostop always"), XOR("auto_stop_always"));
		RegisterElement(&autostop_always_on);

		autostop.setup(XOR("Autostop"), XOR("autostop"));
		autostop.AddShowCallback(callbacks::AUTO_STOP);
		RegisterElement(&autostop);
		...
		fakewalkspeed.AddShowCallback(callbacks::IsFwBound);
		RegisterElement(&fakewalkspeed, 1);

		cripwalk.setup(XOR("Autist shuffle"), XOR("cripwalk"));
...
class MemeTab : public Tab {
public:

	Keybind Optifine;
	Slider  OptifineFov;
	Checkbox modelscale;
	Slider modelscale_amt;
	Checkbox houdini;
	Dropdown othertags;
	Checkbox cancerspec;
	Checkbox wigglyarms;
...
public:
	void init() {
		...
		RegisterElement(&fakeflick);

		Optifine.setup(XOR("Optifine zoom"), XOR("optifine"));
		RegisterElement(&Optifine);

		OptifineFov.setup(XOR("Zoom amount"), XOR("optifineamount"), 1.f, 40.f, true, 0, 20.f, 1.f, XOR(L"°"));
		OptifineFov.AddShowCallback(callbacks::IsOptifineBound);
		RegisterElement(&OptifineFov);

		cancerspec.setup(XOR("Cancer Spectate"), XOR("cancerspec"));
		RegisterElement(&cancerspec);

		wigglyarms.setup(XOR("Wiggly arms"), XOR("wigglyarms"));
		RegisterElement(&wigglyarms);


		// col 2
		modelscale.setup(XOR("Model scale"), XOR("modelscale"));
		RegisterElement(&modelscale, 1);

		modelscale_amt.setup(XOR("Model scale amount"), XOR("scaleamount"), 0.1f, 2.f, true, 1, 0.1f, 0.1f);
		modelscale_amt.AddShowCallback(callbacks::IsModelscaleOn);
		RegisterElement(&modelscale_amt, 1);

		houdini.setup(XOR("Houdini"), XOR("houdini"));
		RegisterElement(&houdini, 1);

		othertags.setup(XOR("Other tags"), XOR("othertags"), { XOR("Off"), XOR("Vulcan"), XOR("Bigshart"), XOR("Smallfart"), XOR("N0GPUHAC|<")});
		RegisterElement(&othertags, 1);
	}
};
...
public:
	void init() {
		...
		buybotenable.setup(XOR("Auto buy"), XOR("buybotenable"));
		RegisterElement(&buybotenable);
		...
		buy1.AddShowCallback(callbacks::IsBuyBotOn);
		...
		buy2.AddShowCallback(callbacks::IsBuyBotOn);
		...
		buy3.AddShowCallback(callbacks::IsBuyBotOn);
		RegisterElement(&buy3);

		notifications.setup(XOR("Logs"), XOR("notifications"), { XOR("Damage"), XOR("Hurt"), XOR("Buy") });
		...
		Aspect.setup(XOR("Aspect ratio"), XOR("Aspect"), 0.f, 2.f, true, 1, 0.f, 0.1f);
		RegisterElement(&Aspect);

		alpha1.setup(XOR("Menu alpha 1"), XOR("alpha1"), 0.f, 255.f, true, 0, 255.f, 1.f);
		RegisterElement(&alpha1);

		alpha2.setup(XOR("Menu alpha 2"), XOR("alpha2"), 0.f, 255.f, true, 0, 255.f, 1.f);
		RegisterElement(&alpha2);
		...
		hitsounds.setup(XOR("Hitmarker sound"), XOR("hitsounds"), { XOR("off"), XOR("arena switch"), XOR("opera"), XOR("bameware"), XOR("dopium"), XOR("bubble"), XOR("cod"), XOR("fatality"), XOR("pop"), XOR("tap") });
		...
		hittext.setup(XOR("Hit text"), XOR("hittext"));
		RegisterElement(&hittext, 1);
		...
		legbreaker.setup(XOR("Leg breaker"), XOR("legbreaker"));
		RegisterElement(&legbreaker, 1);

		killsay.setup(XOR("Cringesay"), XOR("killsay"));
